...
public class FileLevelLoader extends LevelLoader {
    ...
    public void loadLevel(int level) {
        ...
        try {
            FileReader fr = new FileReader("D:\\BAITHIMAU\\Bomerman-btl-oop-master\\Bomerman-btl-oop-master\\bomberman-starter-starter-project-1\\bomberman-starter-starter-project-1\\res\\levels\\Level" + level + ".txt");//doc tep luu map
